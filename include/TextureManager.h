...
public:
	...
	void drawFrame(std::string id, int x, int y, int width, int height, int currentRow, int currentFramem, SDL_Renderer* pRenderer, SDL_RendererFlip flip = SDL_FLIP_NONE);
