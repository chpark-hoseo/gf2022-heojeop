...
void TextureManager::drawFrame(std::string id, int x, int y, int width, int height, int currentRow, int currentFrame, int angle, SDL_Renderer* pRenderer, SDL_RendererFlip flip) {
	SDL_Rect srcRect;
	SDL_Rect dstRect;
